...
namespace exercise.webapi.Data
{
    public class Seeder
    {
        ...
        public Seeder()
        {
            ...
            Random bookRandom = new Random(2);
            Random publisherRandom = new Random(3);
            ...
            for (int y = 1; y < 250; y++)
            {
                ...
                publisher.Id = y;
                publisher.Name = $"{_lastnames[authorRandom.Next(_lastnames.Count)]}";
                //publisher.Books = _books[bookRandom.Next(_books.Count)];
